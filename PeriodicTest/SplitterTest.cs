...
namespace PeriodicTest
{
    ...
    {
        Splitter<int> m_Periodizer;
        Tvqs m_Tvqs;
        //Tvq<int> m_Tvq20150101;
        //Tvq<int> m_Tvq20150601;
        //Tvq<int> m_Tvq20160101;
        //Tvq<int> m_Tvq20160601;


        public SplitterTest()
        {
            m_Periodizer = new Splitter<int>();
            m_Tvqs = new Tvqs();
            //var t = new DateTime(2015, 01, 01, 0, 0, 0, 0);
            //m_Tvq20150101 = new Tvq<int>(t, 100, Quality.Ok);
            //t = new DateTime(2015, 06, 01, 0, 0, 0, 0);
            //m_Tvq20150601 = new Tvq<int>(t, 200, Quality.Ok);
            //t = new DateTime(2016, 01, 01, 0, 0, 0, 0);
            //m_Tvq20160101 = new Tvq<int>(t, 300, Quality.Ok);
            //t = new DateTime(2016, 06, 01, 0, 0, 0, 0);
            //m_Tvq20160601 = new Tvq<int>(t, 500, Quality.Ok);
        }

        [Fact]
        public void SplitPerYear_WhenEmpty_ReturnsEmptyEnumerable()
        {
            var result = m_Periodizer.SplitPerYear(new Timeseries<int>());
